...
const mainDivStyle = {
  backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${mainImage})`,
  ...
  if (weatherData && weatherData.wind.speed > 20) {
    snorkelStatus = (
      <>
        ...
        <h3 style={explanationStyle}>It is not safe to go snorkeling today</h3>
      </>
    );
    ...
    snorkelStatus = (
      <>
        ...
        <h3 style={explanationStyle}>It is safe to go snorkeling today </h3>
      </>
    );
  }
    ...
    return (
      ...
      {weatherData ? (
        ...
        <>
          <h1 style={titleStyle}>Can I Go Snorkeling Today?</h1>
